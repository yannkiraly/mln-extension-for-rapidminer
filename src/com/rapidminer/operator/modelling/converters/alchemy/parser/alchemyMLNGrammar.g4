...
exIntList: startInt COM DOTS COM endInt;
plainIntList: INT (COM INT)*;
intList: exIntList | plainIntList;
number: INT|FLOAT;
...
//Declarations
typeDecl: type EQ LCP (constantList | intList) RCP;
predicateDecl: predicate LP typeList RP;
...
plainFormula: predicateApplication | functionApplication | LSP plainFormula RSP |
              ...
              | plainFormula iff plainFormula | quantifier  variableList
              plainFormula;
