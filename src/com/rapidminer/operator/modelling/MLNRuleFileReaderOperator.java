 ...
 *
 */
public class MLNRuleFileReaderOperator extends MLNAbstractFileReaderOperator {
	...
	public MLNRuleFileReaderOperator(OperatorDescription description)
			throws OperatorException {
		super(description);
	}
