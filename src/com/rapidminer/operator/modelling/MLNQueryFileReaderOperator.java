 ...
 *
 */
public class MLNQueryFileReaderOperator extends MLNAbstractFileReaderOperator {
	 ...
	 */
	public MLNQueryFileReaderOperator(OperatorDescription description)
			throws OperatorException {
		super(description);
	}
