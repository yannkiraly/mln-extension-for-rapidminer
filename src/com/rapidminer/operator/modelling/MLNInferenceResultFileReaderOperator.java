 ...
 *
 */
public class MLNInferenceResultFileReaderOperator extends MLNAbstractFileReaderOperator {
	 ...
	 */
	public MLNInferenceResultFileReaderOperator(OperatorDescription description)
			throws OperatorException {
		super(description);
	}
	...
	protected MLNFileRole getRole() {
		return MLNFileRole.INFERENCE_RESULT;
	}
