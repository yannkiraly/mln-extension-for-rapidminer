...
import com.rapidminer.operator.modelling.configuration.configurator.MLNConfigurationWindow;
 ...
 */
public class PluginInitMLNExtension {
	...
	public static void initGui(MainFrame mainframe) {
		final MLNConfigurationWindow window = new MLNConfigurationWindow();
		mainframe.getDockingDesktop().registerDockable(window);
	}
